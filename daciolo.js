...
const DACIOLO = (function(){
	...
	const quotes = [
		...
		'É Satanás contra a cação brasileira.',
		...
		'Deixa eu falar uma coisa, tem um perigo eminete acontecendo, uma guerra próxima de estourar',
		'A nova ordem mundial ta escravisando nosso povo há anos. ',
		'Chega, chega, chega!',
		'Mas eu tenho algo muito importante pra falar pra nação brasileira: ',
		'Eu tenho algo aqui pra declarar. ',
		'Eu acredito em sinais.',
		'Eu tô aqui agracadecendo a Deus agora.',
